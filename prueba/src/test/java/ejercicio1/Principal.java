...
public class Principal {
	...
	public void caso1() {
		...
		try {
			System.out.println("SALIDA_#1: " + sistemaFerroviario.calcularDistancia(ruta));
	...
	public void caso2() {
		...
		try {
			System.out.println("SALIDA_#2: " + sistemaFerroviario.calcularDistancia(ruta));
	...
	public void caso3() {
		...
		try {
			System.out.println("SALIDA_#3: " + sistemaFerroviario.calcularDistancia(ruta));
	...
	public void caso4() {
		...
		try {
			System.out.println("SALIDA_#4: " + sistemaFerroviario.calcularDistancia(ruta));
	...
	public void caso5() throws Exception {
		...
		try {
			...
			System.out.println("SALIDA_#5: " + "NO HAY TAL RUTA");
			throw new Exception();
		}
	}
	...
	public void caso6() {
		...
		System.out.println("SALIDA_#6: " + cant);
		assertEquals(2, cant);
	}
	...
	public void caso7() {
		...
		System.out.println("SALIDA_#7: " + cant);
		assertEquals(3, cant);
	}
	...
	public void caso8() {
		try {
			...
			System.out.println("SALIDA_#8: " + sistemaFerroviario.calcularDistancia(ruta));
			assertEquals(9, sistemaFerroviario.calcularDistancia(ruta));
		} catch (Exception e) {
			fail(e.getMessage());
			assertEquals("SIN RUTA", e.getMessage());
	...
	public void caso9() {
		try {
			...
			System.out.println("SALIDA_#9: " + sistemaFerroviario.calcularDistancia(ruta));
			assertEquals(9, sistemaFerroviario.calcularDistancia(ruta));
		} catch (Exception e) {
	...
	public void caso10() {
		...
		System.out.println("SALIDA_#10: " + cant);
	}
}
